...
public class StylesServiceTest : BaseComponentTest
{
    ...
    public void GetBadgeStyleWorkflowStatus_ShouldReturnCorrectBadgeStyle(WorkflowStatus status,
    ...
    public void GetBadgeStyleArchivedStatus_ShouldReturnCorrectBadgeStyle(ArchivedStatus status,
        BadgeStyle expectedStyle)
    {
        // Act
